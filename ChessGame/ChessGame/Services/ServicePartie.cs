...
namespace ChessGame.Services
{
    ...
    public class ServicePartie : IServicePartie
    {
        ...
        /// <summary>
        /// Constructeur avec injection partielle (sans historique/sauvegardeur)
        /// </summary>
        public ServicePartie(IValidateurCoup validateurCoup, IReglesJeu reglesJeu)
            : this(validateurCoup, reglesJeu, new HistoriqueCoups(), new Sauvegardeur())
        {
        }

        /// <summary>
        /// Constructeur sans injection : crée les dépendances par défaut.
        /// </summary>
        public ServicePartie()
            : this(new ValidateurCoup(), new ReglesJeu(new ValidateurCoup()))
        {
        }
        ...
        public bool SauvegarderPartie(string cheminFichier)
        {
            ...
            return _sauvegardeur.SauvegarderPGN(Echiquier, EtatPartie, cheminFichier);
        }
